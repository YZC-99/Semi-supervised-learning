...
def split_dataset():
    ...
    all_info = "/home/gu721/yzc/Semi-supervised-learning/data/cxr8/all_dataset.csv"

    train_refer = "/home/gu721/yzc/Semi-supervised-learning/data/cxr8/refer/train.csv"
    val_refer = "/home/gu721/yzc/Semi-supervised-learning/data/cxr8/refer/val.csv"
    test_refer = "/home/gu721/yzc/Semi-supervised-learning/data/cxr8/refer/test.csv"

    # Read the all_info CSV file
    all_data = pd.read_csv(all_info)

    # Read the reference CSV files and extract the 'image' column
    train_images = pd.read_csv(train_refer)['Image Index'].tolist()
    val_images = pd.read_csv(val_refer)['Image Index'].tolist()
    test_images = pd.read_csv(test_refer)['Image Index'].tolist()
