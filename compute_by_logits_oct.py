...
def get_target_names_labels():
    ...
    target_labels = target_all_info.iloc[:, 2:7].values
...
def compute_metrics_multilabel_classes(pred_logits_dir):
    ...
    return compute_metrics(target_labels_ordered, pred_probs,num_classes=5,multi_label=True)
...
if __name__ == '__main__':
    ...
    save_path = os.path.join(save_dir, 'oct-results.csv')
    multi_label=False
