...
from semilearn.datasets.cv_datasets import get_cxr8,get_isic2018,get_cifar, get_eurosat, get_imagenet, get_medmnist, get_semi_aves, get_stl10, get_svhn, get_food101,get_olives
