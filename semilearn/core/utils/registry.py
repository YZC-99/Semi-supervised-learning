...
ALL_MODULES = [
    ...
    ('semilearn.algorithms', ['hyperfixmatch','comatch_wo_graph','comatch_wo_memory','hypercomatch','conmatch','clinfixmatch','clinfixdamatch','adamatch', 'comatch', 'crmatch', 'dash', 'fixmatch','fixdamatch', 'flexmatch', 'fullysupervised', 'meanteacher',
